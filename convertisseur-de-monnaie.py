# importation de la bibliothèque tkinter qui permet de faire une interface graphique
import tkinter as tk

# fonction qui convertit les différents types de monnaies
def convertir():
...
# fonction pour effacer ce qu'on a entré
def effacer_entre():
